...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({CredencialValidaYaExisteException.class, CredencialInvalidaException.class, ObraSocialSinValidadorException.class, PacienteNoExisteException.class,
